...
title: "Limitless Private Cloud – Installing FileBrowser on your VPS"
...
{% image "/assets/images/blog/private-cloud-filebrowser-docker/H1.png", "Terminal output while starting the FileBrowser container", "(max-width: 768px) 100vw, 800px" %}
...
{% image "/assets/images/blog/private-cloud-filebrowser-docker/H2.png", "FileBrowser login screen in the browser", "(max-width: 768px) 100vw, 800px" %}
...
{% image "/assets/images/blog/private-cloud-filebrowser-docker/H3.png", "Password change section in profile settings", "(max-width: 768px) 100vw, 800px" %}
...
{% image "/assets/images/blog/private-cloud-filebrowser-docker/H4.png", "FileBrowser interface showing the file sharing feature", "(max-width: 768px) 100vw, 800px" %}
