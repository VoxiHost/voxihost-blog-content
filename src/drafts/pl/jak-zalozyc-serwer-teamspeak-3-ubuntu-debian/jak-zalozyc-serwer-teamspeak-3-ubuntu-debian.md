...
{% image "/assets/images/blog/setup-teamspeak-3-server-ubuntu-debian/H1.png", "Aktualizacja systemu i instalacja wget oraz bzip2 na Ubuntu", "(max-width: 768px) 100vw, 800px" %}
...
{% image "/assets/images/blog/setup-teamspeak-3-server-ubuntu-debian/H2.png", "Tworzenie użytkownika systemowego teamspeak", "(max-width: 768px) 100vw, 800px" %}
...
{% image "/assets/images/blog/setup-teamspeak-3-server-ubuntu-debian/H3.png", "Pobieranie plików serwerowych TeamSpeak 3", "(max-width: 768px) 100vw, 800px" %}
...
{% image "/assets/images/blog/setup-teamspeak-3-server-ubuntu-debian/H4.png", "Akceptacja warunków licencji TeamSpeak 3", "(max-width: 768px) 100vw, 800px" %}
...
{% image "/assets/images/blog/setup-teamspeak-3-server-ubuntu-debian/H5.png", "Ręczne uruchomienie serwera TS3, aby wygenerować klucz uprawnień", "(max-width: 768px) 100vw, 800px" %}
...
{% image "/assets/images/blog/setup-teamspeak-3-server-ubuntu-debian/H6.png", "Tworzenie usługi systemd dla serwera TeamSpeak", "(max-width: 768px) 100vw, 800px" %}
...
{% image "/assets/images/blog/setup-teamspeak-3-server-ubuntu-debian/H7.png", "Aktywacja i startowanie usługi TeamSpeak w tle", "(max-width: 768px) 100vw, 800px" %}
