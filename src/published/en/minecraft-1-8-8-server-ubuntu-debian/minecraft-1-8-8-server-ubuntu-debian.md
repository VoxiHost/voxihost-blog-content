...
tags:
  ...
  - legacy
howto:
  name: How to Setup a Classic Minecraft (1.8.8/1.16.5) Server on Ubuntu/Debian
  totalTime: PT10M
...
Classic Minecraft versions from the **1.7.10 through 1.16.5** era require **Java 8** for legendary stability. This guide covers the entire classic range. For modern version requirements, check our [Minecraft Java Server Compatibility Guide](/blog/setup-minecraft-server-ubuntu-debian/).
