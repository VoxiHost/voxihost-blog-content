---
image: /assets/images/blog/en/setup-minecraft-server-centos-rhel/og-image.png
title: How to Set Up a Minecraft Java Edition Server on AlmaLinux, CentOS, Rocky Linux & Fedora
description: A complete guide to hosting a Minecraft Java Edition server on RHEL-based Linux. Learn how to install and configure the correct Java environment for every version.
date: '2026-04-23'
...
faq:
  ...
  - question: "What is the difference between openjdk and openjdk-headless packages on AlmaLinux?"
  ...
  - question: "Can I install multiple versions of Java on the same Rocky Linux server?"
    answer: "Yes, you can install multiple Java versions side-by-side using dnf. You can switch the default system version using <code>sudo alternatives --config java</code>, or specify the exact path to the Java binary in your server startup script."
...
Here is the definitive breakdown of Minecraft versions and their corresponding Java requirements on RHEL-based systems:

| Minecraft Version | Java Requirements | Recommended Package | Importance |
| :--- | :--- | :--- | :--- |
| [1.20.5 – 1.21.x](/blog/minecraft-1-21-server-centos-rhel/) | **Java 21** | `java-21-openjdk-headless` | The modern standard. Essential for the latest Vanilla features. |
| [1.18 – 1.20.4](/blog/minecraft-1-19-server-centos-rhel/) | **Java 17** | `java-17-openjdk-headless` | The backbone of many active survival worlds. |
| [1.17 – 1.17.1](/blog/minecraft-1-17-server-centos-rhel/) | **Java 16/17** | `java-17-openjdk-headless` | A transitional update. Java 17 is recommended as a fallback here. |
| [1.7.10 – 1.16.5](/blog/minecraft-1-8-8-server-centos-rhel/) | **Java 8** | `java-1.8.0-openjdk-headless` | The classic era. Extreme stability for legacy and PvP. |

> **Pro Tip for VPS Users:** Notice that we always recommend the `-headless` packages (e.g., `java-21-openjdk-headless`). Headless packages exclude graphical user interface (GUI) libraries that are useless on a terminal-only server. This saves disk space and preserves your RAM for the Minecraft server itself.
...
Because the setup commands differ significantly depending on the "Java Era" you choose, we have broken down the actual installation into specific, easy-to-follow tutorials optimized for `dnf` and `firewalld`:
...
👉 **[Setting Up a Vanilla 1.20.5+ Server (Java 21)](/blog/minecraft-1-21-server-centos-rhel/)**
...
👉 **[Setting Up a Vanilla 1.18 - 1.20.4 Server](/blog/minecraft-1-19-server-centos-rhel/)**
...
👉 **[Setting Up a Vanilla 1.17 Server](/blog/minecraft-1-17-server-centos-rhel/)**
