...
faq:
  ...
  - question: "How does fail2ban integrate with firewalld on AlmaLinux/Rocky Linux?"
    answer: "By setting the <code>banaction</code> variable to <code>firewallcmd-ipset</code> in your <code>jail.local</code>, fail2ban dynamically communicates with firewalld, creating temporary ipsets to efficiently drop banned traffic."
status: published
locale: en
author:
  name: VoxiHost Team
