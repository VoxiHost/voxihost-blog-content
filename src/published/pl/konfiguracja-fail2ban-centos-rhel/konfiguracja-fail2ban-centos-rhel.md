...
faq:
  ...
  - question: "Jak fail2ban integruje się z zaporą firewalld na systemach Rocky/AlmaLinux?"
    answer: "Poprzez ustawienie opcji <code>banaction = firewallcmd-ipset</code> w pliku <code>jail.local</code>. Fail2ban dynamicznie komunikuje się z firewalld, tworząc tymczasowe zestawy ipset, co pozwala na szybkie i wydajne blokowanie ruchu z zablokowanych IP."
status: published
locale: pl
author:
  name: VoxiHost Team
