...
Oto kompletne zestawienie wersji Minecrafta i odpowiadających im wymagań Javy:

| Wersja Minecraft | Wymagania Java | Zalecany pakiet | Znaczenie |
| :--- | :--- | :--- | :--- |
| [1.20.5 – 1.21.x](/pl/blog/serwer-minecraft-1-21-ubuntu-debian/) | **Java 21** | `openjdk-21-jre-headless` | Nowoczesny standard. Niezbędny do najnowszych funkcji Vanilla. |
| [1.18 – 1.20.4](/pl/blog/serwer-minecraft-1-19-ubuntu-debian/) | **Java 17** | `openjdk-17-jre-headless` | Podstawa wielu aktywnych światów survival. |
| [1.17 – 1.17.1](/pl/blog/serwer-minecraft-1-17-ubuntu-debian/) | **Java 16** | `openjdk-16-jre-headless` | Aktualizacja przejściowa. Większość administratorów pomija ją na rzecz 1.18+. |
| [1.7.10 – 1.16.5](/pl/blog/serwer-minecraft-1-8-8-ubuntu-debian/) | **Java 8** | `openjdk-8-jre-headless` | Klasyczna era. Ekstremalna stabilność dla starszych wersji i PvP. |

> **Pro Tip dla użytkowników VPS:** Zawsze zalecamy pakiety `-headless` (np. `openjdk-21-jre-headless`). Pakiety headless nie zawierają bibliotek GUI, które są bezużyteczne na serwerze działającym w trybie terminalowym. Oszczędza to miejsce na dysku i zachowuje RAM dla samego serwera Minecrafta.
...
Ponieważ komendy różnią się znacznie w zależności od wybranej „ery Java", podzieliliśmy instalację na szczegółowe, łatwe do śledzenia tutoriale:
...
👉 **[Konfiguracja serwera Vanilla 1.20.5+ (Java 21)](/pl/blog/serwer-minecraft-1-21-ubuntu-debian/)**
...
👉 **[Konfiguracja serwera Vanilla 1.18 - 1.20.4](/pl/blog/serwer-minecraft-1-19-ubuntu-debian/)**
...
👉 **[Konfiguracja serwera Vanilla 1.17](/pl/blog/serwer-minecraft-1-17-ubuntu-debian/)**
